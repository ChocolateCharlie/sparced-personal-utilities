...
def run_sparced(flagD, th, spdata, genedata, sbml_file, model):
    ...
    # calculate 
    genedata, GenePositionMatrix, AllGenesVec, kTCmaxs, kTCleak, kGin_1, kGac_1, kTCd, TARs0, tcnas, tcnrs, tck50as, tck50rs, spIDs = run_prep(flagD,Vn,model)
